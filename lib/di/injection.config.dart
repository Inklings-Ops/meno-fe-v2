...
import 'package:internet_connection_checker/internet_connection_checker.dart'
    as _i12;
import 'package:meno_fe_v2/di/register_module.dart' as _i36;
import 'package:meno_fe_v2/modules/auth/application/auth/auth_notifier.dart'
    as _i31;
import 'package:meno_fe_v2/modules/auth/application/login/login_notifier.dart'
    as _i29;
import 'package:meno_fe_v2/modules/auth/domain/i_auth_facade.dart' as _i25;
...
import 'package:meno_fe_v2/services/media_service.dart' as _i14;
import 'package:meno_fe_v2/services/secure_storage_service.dart' as _i18;
import 'package:meno_fe_v2/services/shared_preferences_service.dart' as _i20;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i5.BroadcastListenerMapper>(_i5.BroadcastListenerMapper());
    ...
    gh.singleton<_i8.CreatorMapper>(_i8.CreatorMapper());
    ...
    gh.factory<_i13.JoinBroadcastDataMapper>(
        () => _i13.JoinBroadcastDataMapper());
    gh.lazySingleton<_i14.MediaService>(
        () => _i14.MediaService(gh<_i11.ImagePicker>()));
    gh.lazySingleton<_i15.ProfileMapper>(() => _i15.ProfileMapper());
    gh.lazySingleton<_i16.ProfileRemoteDatasource>(
        () => registerModule.profileRemote);
    gh.lazySingleton<_i17.ProfileStatsMapper>(() => _i17.ProfileStatsMapper());
    ...
    await gh.factoryAsync<_i20.SharedPreferencesService>(
      () => registerModule.sharedPrefService,
      preResolve: true,
    );
    gh.singleton<_i21.UserCredentialsMapper>(_i21.UserCredentialsMapper());
    gh.singleton<_i22.UserMapper>(_i22.UserMapper());
    gh.factory<_i23.AuthLocalDatasource>(
        () => _i23.AuthLocalDatasource(gh<_i18.SecureStorageService>()));
    gh.factory<_i24.BroadcastLocalDatasource>(
        () => _i24.BroadcastLocalDatasource(
              gh<_i18.SecureStorageService>(),
              gh<_i20.SharedPreferencesService>(),
            ));
    gh.lazySingleton<_i25.IAuthFacade>(() => _i26.AuthFacade(
          gh<_i10.GoogleSignIn>(),
          gh<_i23.AuthLocalDatasource>(),
          gh<_i4.AuthRemoteDatasource>(),
          gh<_i21.UserCredentialsMapper>(),
        ));
    gh.lazySingleton<_i27.IBroadcastFacade>(() => _i28.BroadcastFacade(
          gh<_i24.BroadcastLocalDatasource>(),
          gh<_i7.BroadcastRemoteDatasource>(),
          gh<_i6.BroadcastMapper>(),
        ));
    gh.factory<_i29.LoginNotifier>(
        () => _i29.LoginNotifier(gh<_i25.IAuthFacade>()));
    gh.factory<_i30.ProfileLocalDatasource>(
        () => _i30.ProfileLocalDatasource(gh<_i18.SecureStorageService>()));
    gh.factory<_i31.AuthNotifier>(
        () => _i31.AuthNotifier(gh<_i25.IAuthFacade>()));
    gh.factory<_i32.BroadcastFormNotifier>(() => _i32.BroadcastFormNotifier(
          gh<_i27.IBroadcastFacade>(),
          gh<_i14.MediaService>(),
        ));
    gh.factory<_i33.BroadcastNotifier>(
        () => _i33.BroadcastNotifier(gh<_i27.IBroadcastFacade>()));
    gh.factory<_i34.IProfileFacade>(() => _i35.ProfileFacade(
          gh<_i30.ProfileLocalDatasource>(),
