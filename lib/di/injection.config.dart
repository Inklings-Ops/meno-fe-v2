...
import 'package:meno_fe_v2/modules/profile/infrastructure/profile_facade.dart'
    as _i40;
import 'package:meno_fe_v2/services/background_service.dart' as _i5;
import 'package:meno_fe_v2/services/livekit_service.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i5.BackgroundService>(() => _i5.BackgroundService());
    ...
    gh.lazySingleton<_i19.LivekitService>(() => registerModule.livekitService);
    gh.factory<_i20.LoginNotifier>(
        () => _i20.LoginNotifier(gh<_i14.IAuthFacade>()));
    gh.lazySingleton<_i21.MediaService>(
        () => _i21.MediaService(gh<_i16.ImagePicker>()));
