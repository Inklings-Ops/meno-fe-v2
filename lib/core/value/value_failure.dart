...
class ValueFailure<T> with _$ValueFailure<T> {
  ...
  const factory ValueFailure.invalidOTP([T? f]) = InvalidOTP<T>;
  const factory ValueFailure.invalidImageType([T? f]) = InvalidImageType<T>;
  const factory ValueFailure.invalidIDToken([T? f]) = InvalidIDToken<T>;
  const factory ValueFailure.invalidTitle([T? f]) = InvalidTitle<T>;
}
